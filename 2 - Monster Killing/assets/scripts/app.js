...
const LOG_EVENT_MONSTER_ATTACK = 'MONSTER_ATTTACK';
...
function attackMonster(mode) {
  ...
  // the if statment below is just for my own understanding   
...
function healPlayerHandeler() {
  ...
  if (currentPlayerHealth >= chosenMaxLife - HEAL_VALUE) {
    alert("your can't heal to more than your max initial health.");
